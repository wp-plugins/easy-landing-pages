...
function kickofflabsAdminMenu()
{
	...
	if ( current_user_can( 'manage_options' ) ) {
		add_menu_page( 'KickoffLabs', 'KickoffLabs', 'manage_options', 'kickofflabs-api' );
...
class KickofflabsAPIAdmin
{
    ...
    private $templateMessages = array(
        ...
        'new_api_key_valid' => array('color' => '4AB915', 'text' => 'Congratulations! You\'re ready to start publishing landing pages to wordpress. Click "<a href="?page=kickofflabs-landingpage">Landing Pages</a>" or "<a href="?page=kickofflabs-signupbar">Signup Bar</a> on your page." .'),
    ...
    private function updateCredentials( $email, $password )
    {
        ...
        $this->currentMessages[] = 'new_api_key_valid';
